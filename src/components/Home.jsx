                    ...
                    <div className='z-[200] w-screen h-14 sm:h-14 backdrop-blur-[10px] fixed top-0 flex '>
                         <div>
                              <div className='flex place-content-center items-end absolute right-0 p-1'>
                                   ...
                                   <div onClick={() => setWeatherState('white', 'linear-gradient(to right, #a0aec0, #1a202c, #000000)', 'white', 'bg-gradient-to-r from-gray-500 via-gray-900 to-black', false, true, false, false)} className='cursor-pointer active:bg-slate-80 md:hover:opacity-80 rounded-md p-2'>
