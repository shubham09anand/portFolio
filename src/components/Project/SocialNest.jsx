        ...
        <div className="text-zinc-800">
            <div className="md: items-center rounded-lg py-10 bg-gray-100">
                <div className="w-full shadow-2xl rounded-l-md p-2 scale-95">
                    ...
                    <div className="font-bold text-5xl mb-2 text-[#324997] text-center">SocialNest</div>
                    <Carousel className=''>
                    ...
                    <div className='p-2'>
                        <div className="py-4">
                            ...
                            <p className="text-white font-medium text-xl">
                                "SocialNest" is a dynamic social media platform offering users a seamless experience to connect, engage, and express themselves online.                            </p>
                        </div>
